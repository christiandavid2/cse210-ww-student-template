...
public class GoalManager
    {
        ...
        // Leveling: 1 level per 1000 points
        ...
        // Record an event for goal index (1-based display index).
            ...
            for (int i = 2; i < lines.Length; i++)
            {
                ...
                try
                {
                    if (type == "Simple")
                    {
                        ...
                        // reflection-ish: set completion by simulating RecordEvent if complete
                        if (complete)
                        {
                            g.RecordEvent(); // mark as complete
                        }
                        loadedGoals.Add(g);
                    }
        ...
        // Simple badge logic - you can expand this
        ...
        // For program/demo convenience, a quick method to list goal creation options
